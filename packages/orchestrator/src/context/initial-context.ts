export const initialContext = `<useful-context>
## Project Type
...
└── src/
    ...
    ├── components/
    │   ├── NavLink.tsx
    │   └── ui/  [shadcn/ui — see Available Components section]
    ├── hooks/
    │   ├── use-mobile.tsx
    │   └── use-toast.ts
    └── lib/
...
- Animation: tailwindcss-animate, vaul, embla-carousel-react

## Notes
- This is the first message. The codebase is an unmodified template.
- No custom components have been created yet.
- No design system has been defined yet beyond the template defaults.
</useful-context>`;
